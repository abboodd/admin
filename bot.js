...
client.on("message", message => {
 if (message.content === "r-help") {
  ...
  ══════════ξ☠╚⊙ ⊙╝════════════  
   ...
   ⚡  r-bc 「للبرودكاست بأميد」
 
   ⚡  r-allbc 「للبرودكاست بدون أميد」
 
   ⚡  r-onlinebc 「لأرسال برودكاست للاونلاين فقط」
 
   ⚡  r-rolebc 「لأرسال برودكاست لرتبة معينه」
 ...
 「لتغير أسم شخص ما」
   ...
   ⚡ r-createcolors 「لعمل 137 لون مرتب」
 
   ⚡ r-deletecolors 「لحذف 137 لون」
 
   ⚡ r-ban 「لتعطي شخص باند مع السبب」
    
   ⚡ r-kick 「لتعطي شخص كيك مع السبب」
    
   ⚡امسح
 「لمسح الشات」
    
   ⚡ r-v  「لانشاء روم صوتي مؤقت」
 
   ⚡ r-cc  「لانشاء كاتجوري 」
 
   ⚡ r-cv  「لانشاء روم صوتي دائم 」
 
   ⚡ r-ct  「لانشاء روم كتابي دائم 」
 
   ⚡ r-delet   「يحذف الـروم سواء صوتي او كتابي」

   ⚡ r-invites   「لمعرفة كم شخص جبته للسيرفر」
...
client.on('message', message => {
    var prefix = "!";
      ...
      if (message.author.id == 398220765377462283) return;
...
client.on("message", message => {
    ...
    if( msg.toLowerCase().startsWith( prefix + 'ول ازاله' ) ){
